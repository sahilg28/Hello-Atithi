...
const HeroSection2 = () => {
    return (
        <div className="flex flex-col md:flex-row items-center justify-center gap-20 py-10 px-2 max-w-7xl mx-auto ">
            <div className="md:w-5/12 flex items-center justify-center">
                <img 
                    src={travelExpertImage} 
                    alt="Travel Expert" 
                    className=" max-w-xl object-cover hidden md:block " 
                />
            </div>
            <div className="md:w-8/12 max-w-md mb-14">
                <div className="flex flex-col items-center space-y-8 ">
                    <h1 className="text-sky-600 text-3xl font-bold text-center">
