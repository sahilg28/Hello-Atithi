...
const CategoryCard = ({ title, description, image, onViewMore }) => (
  ...
  const categories = [
    {
      ...
      image: imkImage1,
      onViewMore: () => window.location.href = "/blog-all-you-should-know-about-india",
    },
    {
      ...
      <div>
        {categories.map((category, index) => (
          <CategoryCard
            ...
            onViewMore={category.onViewMore}
          />
        ))}
      </div>
    </div>
