...
const WhatWeDo = () => {
    return (
        <section className="text-center py-14 px-12">
            <h2 className="text-sky-600 text-3xl font-bold mb-6 uppercase">What We Do</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 ">
                <div className="flex flex-col items-center text-center">
                    <img src={whatWedoIndiaSafe} alt="Makes India easy for you" className="w-52 h-auto mb-4" loading="lazy" />
                ...
                <div className="flex flex-col items-center text-center">
                    <img src={whatWedoSaves} alt="Saves You From Scams" className="w-52 h-auto mb-4" loading="lazy" />
                    <h3 className="text-2xl font-bold text-black mt-2">SAVES YOU FROM SCAMS</h3>
                    <p className="text-black mt-6 px-10 text-lg">
                ...
                <div className="flex flex-col items-center text-center">
                    <img src={whatWedoSupport} alt="Support at Every Step" className="w-52 h-auto mb-4" loading="lazy" />
            ...
            <div className="mt-10">
                <button className="bg-pink-700 text-white text-lg font-semibold py-4 px-4 ">
                    HOW THIS WORKS
                </button>
            </div>
        </section>
