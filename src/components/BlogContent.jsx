      ...
      <div className="grid grid-cols-4 gap-12">
        <div className="col-span-3">
          <div className="space-y-4">
            <h1 className="text-black text-2xl font-bold underline">Essential Guide: Indian Visa Requirements 2025</h1>
            
            <p className="text-black text-lg leading-relaxed">
              Planning a trip to India? Understanding the visa requirements is crucial for a smooth journey. 
              This comprehensive guide covers everything you need to know about obtaining an Indian visa in 2025.
            </p>
            <img 
              src={IMK5} 
            ...
            <h2 className="text-black text-xl font-semibold underline">Types of Indian Visas</h2>
            <p className="text-black text-lg leading-relaxed">
              India offers various types of visas including tourist, business, and e-visas. The e-visa process 
              has been streamlined for 2025, making it easier for travelers from eligible countries to visit India.
            </p>

            <h2 className="text-black text-xl font-semibold underline">Required Documents</h2>
            <p className="text-black text-lg leading-relaxed">
              Ensure you have a valid passport with at least six months validity, recent passport-sized photographs, 
              and proof of residence. Additional documents may be required based on your visa type.
            </p>

            <h2 className="text-black text-xl font-semibold underline">Application Process</h2>
            <p className="text-black text-lg leading-relaxed">
              The online application process is straightforward. Fill out the form, upload required documents, 
              pay the fee, and schedule your appointment if necessary. Processing times vary by visa type.
            </p>

            <h2 className="text-black text-xl font-semibold underline">Visa Fees and Duration</h2>
            <p className="text-black text-lg leading-relaxed">
              Visa fees vary by type and duration. Tourist visas typically range from 30 days to 1 year. 
              Check the official website for the most current fee structure and payment methods.
            </p>
          </div>
